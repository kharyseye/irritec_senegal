...
class MesProgrammesScreen extends StatefulWidget {
  @override
  _MesProgrammesScreenState createState() => _MesProgrammesScreenState();
}

class _MesProgrammesScreenState extends State<MesProgrammesScreen> {
  int _currentIndex = 3; // Correspond à la position actuelle dans la navbar
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                "Irrigation de la parcelle de Tomates",
        ...
        const SizedBox(height: 10),
        Text(
          "Activer l'irrigation intelligente",
